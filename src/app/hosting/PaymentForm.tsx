             ...
             <div className="space-y-4">
                <div className={`border-t ${theme === 'light' ? 'border-gray-200' : 'border-white/20'} pt-4`}>
                    <div className="flex flex-col sm:flex-row items-center gap-2">
                         <input type="text" value={couponCode} onChange={(e) => setCouponCode(e.target.value.toUpperCase())} placeholder="Coupon Code" className={`flex-grow w-full px-3 py-2 ${themeStyles.input} border rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm`} disabled={!!appliedCoupon} />
